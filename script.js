...
function updateFavicon() {
    ...
    if (favicon) {
        ...
        if (isDarkMode) {
            ...
            favicon.href =
                `assets/favicon-light.png?v=${version}`;

        } else {

            favicon.href =
                `assets/favicon-dark.png?v=${version}`;
        }
    }
}

/* OPEN GRAPH META TAGIEN PÄIVITYS */
...
async function navigate(page, id = null) {
    ...
    // Päivitetään osoiterivi ilman reloadia
    ...
    try {
        ...
        // Poimitaan vain content-wrapper
...
async function renderFrontPage() {
    ...
    if (mainArea) {
        ...
        mainArea.innerHTML = `
            <div
                class="main-article-card"
                onclick="navigate('uutinen', ${main.id})"
            >

                <div class="img-container-32">
                    <img src="${main.image}">
                </div>
